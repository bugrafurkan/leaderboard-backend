...
export const ENV = {
  ...
  DB_HOST: process.env.DB_HOST || 'leaderboard-db',
  ...
  REDIS_URL: process.env.REDIS_URL || 'redis://leaderboard-redis:6379',
  RABBITMQ_URL: process.env.RABBITMQ_URL || 'amqp://leaderboard-rabbitmq:5672',
